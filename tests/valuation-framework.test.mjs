...
test("completed valuation keeps the four-part framework in the contract but folds it out of the reading surface", () => {
  assert.doesNotMatch(app, /valuationFrameworkMarkup/);
  assert.match(app, /Boolean\(valuation\.valuation_framework\)/);
